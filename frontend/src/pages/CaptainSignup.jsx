...
const CaptainSignup = () => {
  ...
  return (
    ...
    <p className='text-center'>
      Already have an Account ? <Link to="/captain-login" className='text-[#275dad]'>Login here</Link>
    </p>
    </div>
    <div>
      <p className='leading-tight text-[12px] text-zinc-400'>
      Your safety is our priority. Our platform is protected with advanced security measures to ensure your personal information and payments stay safe and secure.
      </p>
    </div>
    </div>
  )
