    ...
    <div className="p-7 flex flex-col justify-between h-screen">
      <div>
        ...
        <p className="text-center">
          ...
          <Link to="/login" className="text-[#275dad]">
            Login here
          </Link>
        </p>
      </div>
      <div>
        <p className="leading-tight text-[12px] text-zinc-400">
          Join our community and enjoy fast, reliable rides at your fingertips.
          Sign up today and start your journey with just a few clicks!
        </p>
      </div>
    </div>
  );
